...
export async function sendTestEth(wallet, provider) {
...
export async function airdropCall(wallet, setUserAppInformation) {
  try {
...
export async function airdropFirstJournal(address) {
  try {
