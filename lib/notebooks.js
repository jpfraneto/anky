...
async function processFetchedDementor(rawDementor) {
  try {
    ...
    for (const dementorPage of rawDementor.pages) {
      ...
      let pagePromptsContentFromArweave, pageWritingsContentFromArweave;
      ...
      dementorPagesWithAdditionalData.push({
        prompts: pagePromptsContentFromArweave,
        writings: pageWritingsContentFromArweave,
