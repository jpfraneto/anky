...
const WritingGameComponentMobile = ({
  notebookType,
  targetTime,
  notebookTypeId,
  backgroundImage,
        ...
        <div>
          ...
          <textarea
            ...
            className={`${dancingScript.className} ${text && 'absolute'} ${
              text ? 'md:aspect-video md:flex w-full h-3/5' : ' w-full h-2/4'
            } p-4 text-white ${
              time > 2 && 'opacity-80'
            } placeholder-white  text-2xl border border-white rounded-md  bg-opacity-10 bg-black`}
            value={text}
            placeholder='just write what comes...'
...
export default WritingGameComponentMobile;
