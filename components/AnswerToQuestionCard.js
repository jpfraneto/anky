...
const AnswerToQuestionCard = ({ answer }) => {
  return (
    <div className='w-full my-2 flex flex-row items-center  rounded-xl bg-gray-700 border-white border-2 shadow-orange-300 shadow-md'>
